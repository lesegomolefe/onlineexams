...
<div class="row">
<div class="col-lg-6">
<span class="logo">Online Student Exam System</span></div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">lesego molefe</a>
		...
		<h4 style="font-family:'typo' ">Tshwane University of Tech</h4></div></div>
		</p>
      </div>

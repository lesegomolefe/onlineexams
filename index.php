...
<head>
  ...
  <title>Online Student Exam System </title>
  ...
  <div class="header">
    <div class="row">
      ...
      <div class="col-md-2 col-md-offset-4">
        <a href="loginpage.php" class="pull-right btn sub1" style="border-radius:0%" 
  ...
  <div class="bg1">
    <div class="row">
      ...
      <div class="col-md-4 panel ">
        <!-- sign in form begins -->
        <form class="form-horizontal" name="form" action="sign.php?q=loginpage.php" onSubmit="return validateForm()"
          method="POST">
          <fieldset>
            ...
            <label class="col-md-12 control-label" for="gender"></label>
              <div class="col-md-12">
                <select id="College" name="college" placeholder="College" class="form-control input-md">
                  ...
                  <option value="um">University of Mpumalanga</option>
                  <option value="vut">Vall University of Technology</option>
                  <option value="unisa">University of SouthAfrica</option>
                  <option value="F">witwatersrand University</option>
                  <option value="nw">North West University</option>
                  <option value="wc">University of Western Cape</option>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="mob" name="mob" placeholder="Contact Number" class="form-control input">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="cpassword" name="cpassword" placeholder="Conformation Password" class="form-control input-md"
                  type="password">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="submit" class="sub btn btn-primary" value="Register" />
              </div>
            </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-4">
              <img src="image/lesego (1).jpeg" width=100 height=100 alt="lesego molefe" class="img-rounded">
            </div>
            <div class="col-md-5">
              <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none"
                title="Find on Facebook">lesego molefe</a>
              <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">0624959771</h4>
